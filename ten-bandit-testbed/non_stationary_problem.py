...
action-value estimates in non-stationary problems, presented in Sutton (Reinforcement Learning 
2018) p.33 ex 2.5
"""
from stationary_problem import Enviroment
...
def main():
    k = 10
    agents = [Agent(k, 0.1), Agent(k, 0.1, 'constant')]
    testbed = Testbed(k)
    iterations = 2000
    plays = 10000
